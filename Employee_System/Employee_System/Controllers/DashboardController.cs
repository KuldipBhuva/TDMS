...
namespace Employee_System.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<TripModel> lstTripTmrw = new List<TripModel>();
            lstTripTmrw=objService.getTmrwTrips(cid,bid);
            objEmp.ListTripTmrw = new List<TripModel>();
            objEmp.ListTripTmrw.AddRange(lstTripTmrw);

            List<TripModel> lstTripTmrw5 = new List<TripModel>();
            lstTripTmrw5 = objService.getnext5Trips(cid, bid);
            objEmp.ListTripTmrw5 = new List<TripModel>();
            objEmp.ListTripTmrw5.AddRange(lstTripTmrw5);

            List<TripModel> lstTripToday = new List<TripModel>();
            lstTripToday = objService.getTodayTrips(cid, bid);
            objEmp.ListTripToday = new List<TripModel>();
            objEmp.ListTripToday.AddRange(lstTripToday);
            return View(objEmp);
